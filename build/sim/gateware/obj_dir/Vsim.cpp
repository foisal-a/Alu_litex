...
void Vsim::eval() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/foisal/Litex/build/sim/gateware/sim.v", 20, "",
...
void Vsim::_eval(Vsim__Syms* __restrict vlSymsp) {
    ...
    if (((IData)(vlTOPp->sys_clk) & (~ (IData)(vlTOPp->__Vclklast__TOP__sys_clk)))) {
        ...
        vlSymsp->TOP__sim._sequent__TOP__sim__46(vlSymsp);
        vlSymsp->TOP__sim._sequent__TOP__sim__47(vlSymsp);
        vlSymsp->TOP__sim._sequent__TOP__sim__48(vlSymsp);
        vlSymsp->TOP__sim._sequent__TOP__sim__49(vlSymsp);
        vlSymsp->TOP__sim._sequent__TOP__sim__50(vlSymsp);
        vlSymsp->TOP__sim._sequent__TOP__sim__51(vlSymsp);
        vlSymsp->TOP__sim._sequent__TOP__sim__52(vlSymsp);
        ...
        vlSymsp->TOP__sim._sequent__TOP__sim__53(vlSymsp);
        vlSymsp->TOP__sim._sequent__TOP__sim__54(vlSymsp);
        vlSymsp->TOP__sim._sequent__TOP__sim__55(vlSymsp);
        vlSymsp->TOP__sim__VexRiscv._settle__TOP__sim__VexRiscv__13(vlSymsp);
    }
    vlSymsp->TOP__sim._combo__TOP__sim__56(vlSymsp);
